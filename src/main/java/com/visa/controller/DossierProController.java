...
public class DossierProController {
    ...
    @GetMapping("/dossier-pro/scanner")
    public String scannerDossier(@RequestParam("id") Integer dossierProfessionnelId,
            RedirectAttributes redirectAttributes) {
        redirectAttributes.addFlashAttribute("infoMessage",
                "Scanner a brancher pour le dossier professionnel #" + dossierProfessionnelId + ".");
